<template>
  <el-container>
    <el-header>
      <el-row>
        <el-col :span="12"><div class="title">TÍNH THÙ LAO FIBER ĐỢT 1 </div></el-col>
        <el-col :span="12">
          Chọn tháng để xem: 
          <!-- <el-date-picker
    ...
    <el-main>
        <el-table
          ...
          <el-table-column prop="tilethulao" label="Tỉ lệ thù lao đợt 1" width="180"></el-table-column>
          <el-table-column prop="thangchitra" label="Tháng chi trả đợt 1" width="180"></el-table-column>
          <el-table-column prop="ngaytinhchitra" label="Ngày tính chi trả đợt 1" width="180"></el-table-column>
   ...
   data() {
      return {
        ...
        columns:{
          ...
          "Tỉ lệ thù lao đợt 1":"tilethulao",
          "Tháng chi trả đợt 1":"thangchitra",
          "Ngày tính chi trả đợt 1":"ngaytinhchitra",
          "Ghi chú":"ghichu"
        },
        thang_tt:'',
        posts:[],
    ...
    methods:{
      datepickerClick(){
        if(this.thang_tt)
          this.LayDS_Thulao_Fiber_Theo_Thang_D1()
      },
      LayDS_Thulao_Fiber_Theo_Thang_D1(){
        var self=this
        self.$message('Đang lấy dữ liệu xin chờ...');
        self.loading=true;
        var data={"monthFrom":self.thang_tt[0],
                  "monthTo":self.thang_tt[1],}
        FiberRepository.LayDS_Thulao_Fiber_Theo_Thang_D1(data).then(function(response){
